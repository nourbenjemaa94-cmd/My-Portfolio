    ...
    <Section id="education" className={SECTION_CLASS}>
      ...
      <div className="relative">
        ...
        <m.div
          ...
          className="relative mx-auto mt-10 md:absolute md:right-0 md:-top-2 md:mx-0 md:mt-0 rotate-[-3deg] bg-white border-[12px] border-white shadow-xl w-52 md:w-64 flex-shrink-0"
        >
          <WashiTape
          ...
          />
          <div className="w-full h-64 md:h-80 overflow-hidden bg-white">
            <img
              src="/nou2.jpeg"
              alt="Nour Ben Jemaa"
              width={640}
